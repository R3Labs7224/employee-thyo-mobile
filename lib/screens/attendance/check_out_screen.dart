...
class _CheckOutScreenState extends State<CheckOutScreen>
  ...
  Future<void> _performCheckOut() async {
    ...
    if (employee != null) {
      ...
      if (success) {
        ...
        _showErrorDialog(attendanceProvider.error ?? 'Check-out failed');
      }
    }
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Make sure to complete all your active tasks before checking out',
                              style: TextStyle(
  ...
  String _calculateWorkingHours() {
    ...
    if (todayAttendance?.checkInTime != null) {
      final checkInTime = DateTime.parse(todayAttendance!.checkInTime!);
